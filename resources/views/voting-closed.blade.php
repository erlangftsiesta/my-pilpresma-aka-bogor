                ...
                <div class="p-12 text-center">
                    ...
                    <div class="mb-8 relative inline-block">
                        ...
                        <div class="relative p-6">
                            <svg class="w-24 h-24 text-red-900" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="flex items-center justify-center gap-2 mb-8">
                        <div class="bg-gradient-to-r from-red-500 to-red-600 px-6 py-2 rounded-xl flex items-center gap-2">
                            ...
                            <span class="font-bold text-white">DITUTUP</span>
                        </div>
                    </div>
                    ...
                    <div class="bg-gradient-to-r from-yellow-50 via-orange-50 to-yellow-50 border-2 border-yellow-300 rounded-2xl p-8 max-w-2xl mx-auto mb-8 shadow-lg">
                        <div class="flex items-start gap-4">
                            <div class="p-3 bg-yellow-500 rounded-xl flex-shrink-0">
                                <svg class="w-7 h-7 from-blue-900 to-blue-950" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div class="flex items-center justify-center gap-4">
                            <div class="text-center flex-1">
                                <div class="w-12 h-12 bg-gray-300 rounded-full flex items-center justify-center mx-auto mb-2">
                                    <svg class="w-6 h-6 from-blue-900 to-blue-950" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                                    </svg>
                                </div>
                    ...
                    <!-- <div class="mt-8">
                        <a href="{{ route('dashboard') }}" 
                            class="inline-flex items-center justify-center gap-3 bg-gradient-to-r from-slate-600 to-slate-700 hover:from-slate-700 hover:to-slate-800 from-blue-900 to-blue-950 px-10 py-4 rounded-xl font-bold shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-200 text-lg">
