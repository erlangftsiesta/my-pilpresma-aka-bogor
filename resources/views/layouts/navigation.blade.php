    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            @if(auth()->user()->isAdmin())
                ...
                <x-responsive-nav-link :href="route('admin.votes')" :active="request()->routeIs('admin.votes')">
                    {{ __('Votes') }}
                </x-responsive-nav-link>
                <x-responsive-nav-link :href="route('admin.candidates')" :active="request()->routeIs('admin.candidates')">
                    {{ __('Candidates') }}
                </x-responsive-nav-link>
                <x-responsive-nav-link :href="route('admin.periods')" :active="request()->routeIs('admin.periods')">
                    {{ __('Periods') }}
                </x-responsive-nav-link>
            @else
