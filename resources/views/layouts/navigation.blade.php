<nav x-data="{ open: false }" class="sticky top-0 z-50 bg-white/95 border-b border-[var(--champagne-gold)]/30">
            ...
            <div class="flex justify-between h-20">
                <div class="flex">
                    ...
                    <div class="shrink-0 flex items-center">
                        <a href="{{ route('dashboard') }}" class="flex items-center gap-3">
                            <img src="{{ asset('images/bp_pilpresma.jfif') }}" alt="Logo"
                                class="h-10 w-10 rounded-xl object-cover shrink-0">
                            
                            <span class="font-['Poppins'] text-xl lg:text-2xl font-bold text-[var(--soft-navy)]">
                                BP PILPRESMA
                            </span>
                        </a>
                    </div>
                ...
                <div class="hidden sm:flex sm:items-center sm:ml-6">
                    <x-dropdown align="right" width="56">
                        <x-slot name="trigger">
                            <button
                                class="inline-flex items-center px-6 py-3 border border-[var(--champagne-gold)] rounded-full text-sm leading-4 font-medium text-[var(--soft-navy)] bg-white hover:bg-[var(--off-white)] focus:outline-none transition-all duration-300 space-x-2">
                ...
                <div class="-mr-2 flex items-center sm:hidden">
                    <button @click="open = ! open"
                        class="inline-flex items-center justify-center p-2 rounded-md text-[var(--soft-navy)] hover:bg-[var(--off-white)] transition-all duration-300">
