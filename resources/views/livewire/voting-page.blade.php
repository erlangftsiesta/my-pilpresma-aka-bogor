<div class="py-12 bg-gradient-to-br from-slate-50 to-blue-50 min-h-screen">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <div
            class="max-w-2xl mx-auto mb-8 bg-gradient-to-r from-red-50 to-red-100 border-2 border-red-300 text-red-800 px-6 py-4 rounded-xl flex items-center gap-3 shadow-lg">
        ...
        <div class="mt-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
            ...
            <div wire:click="selectCandidate({{ $candidate->id }})"
                ...
                <div class="relative overflow-hidden">
                    ...
                    @else
                    <div
                        class="w-full h-72 bg-gradient-to-br from-slate-200 to-blue-200 flex items-center justify-center">
                ...
                <div class="p-6">
                    ...
                    <!-- View Detail Link -->
                    <a href="{{ route('candidate.detail', $candidate->id) }}" onclick="event.stopPropagation()"
                    ...
                    @else
                    <div
                        class="mt-4 bg-gradient-to-r from-gray-100 to-blue-100 text-gray-700 px-4 py-3 rounded-xl text-center font-semibold border-2 border-gray-200 group-hover:border-blue-300 transition-colors">
                        Klik untuk Memilih
                    </div>
                    @endif
                </div>
        ...
        <div class="mt-8 text-center animate-fadeIn">
            <div class="bg-white rounded-2xl shadow-2xl p-8 max-w-2xl mx-auto mb-6">
                ...
                <button style="background: red;" type="button" wire:click="submitVote" wire:loading.attr="disabled"
                    wire:target="submitVote" class="
    ...
    ">
        ...
        <!-- <div class="text-center">
            <div
                class="bg-slate-600 border-2 border-yellow-300 rounded-2xl p-8 max-w-2xl mx-auto shadow-lg">
