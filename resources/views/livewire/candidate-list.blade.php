                ...
                <div class="flex items-center justify-between">
                    <div class="flex-1">
                        <div class="flex items-center space-x-3 mb-2">
                            <div class="w-10 h-10 flex items-center justify-center backdrop-blur-sm">
...
<div class="p-6 flex flex-col h-full">
    ...
    <div class="flex items-start space-x-3 mb-4">
        ...
        <div class="flex-1">
            <h3 class="font-bold text-2xl text-[var(--navy-blue)] leading-tight 
                       group-hover:text-[var(--sky-blue)] transition-colors duration-300">
    ...
    <!-- DESCRIPTION -->
    <p class="text-[var(--navy-blue)]/70 leading-relaxed line-clamp-3 text-sm mb-6">
