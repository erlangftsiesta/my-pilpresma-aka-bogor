<div class="py-12 bg-gradient-to-br from-slate-50 to-blue-50 min-h-screen">
        ...
        <div class="bg-white rounded-2xl shadow-xl overflow-hidden">
            ...
            <div class="bg-gradient-to-r from-slate-800 to-slate-700 p-6">
                <div class="flex justify-between items-center">
                    <div>
                        <h3 class="text-2xl font-bold from-purple-500 to-purple-600 font-bold bg-gradient-to-r from-blue-600 via-purple-600 to-blue-600 mb-1">Manajemen Kandidat</h3>
            ...
            <div class="p-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div class="group bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden border-2 border-transparent hover:border-blue-300 transform hover:-translate-y-2">
                    <!-- Photo Section -->
                    <div class="relative overflow-hidden">
                        ...
                        @else
                        <div class="w-full h-56 bg-gradient-to-br from-slate-200 to-blue-200 flex flex-col items-center justify-center">
                        ...
                        <!-- Floating Badge -->
                        <div class="absolute top-4 right-4 bg-white/90 backdrop-blur-sm px-3 py-1.5 rounded-lg shadow-lg">
    ...
    <!-- Modal -->
    @if($showModal)
    <div class="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4 overflow-y-auto animate-fadeIn">
        <div class="bg-white rounded-2xl shadow-2xl max-w-2xl w-full my-8 transform animate-slideUp">
            ...
            <div class="bg-gradient-to-r from-slate-800 to-slate-700 p-6 rounded-t-2xl">
                <h3 class="text-2xl font-bold from-purple-500 to-purple-600 font-bold bg-gradient-to-r from-blue-600 via-purple-600 to-blue-600flex items-center gap-3">
            ...
            <form wire:submit.prevent="{{ $editMode ? 'update' : 'store' }}" class="p-6 space-y-5 max-h-[calc(100vh-200px)] overflow-y-auto">
                <!-- Nama Kandidat -->
                <div>
                ...
                <div>
                    ...
                    <div class="mb-3 relative inline-block">
                        ...
                        <div class="absolute -bottom-2 -right-2 bg-blue-500 from-purple-500 to-purple-600 font-bold bg-gradient-to-r from-blue-600 via-purple-600 to-blue-600 text-xs font-bold px-3 py-1 rounded-lg shadow">
                            Foto Saat Ini
                        </div>
                    </div>
                    @endif
                    ...
                    <div class="mt-4 relative inline-block">
                        <img src="{{ $photo->temporaryUrl() }}" 
                            class="w-40 h-40 object-cover rounded-xl shadow-lg border-4 border-white">
                        <div class="absolute -bottom-2 -right-2 bg-green-500 from-purple-500 to-purple-600 font-bold bg-gradient-to-r from-blue-600 via-purple-600 to-blue-600 text-xs font-bold px-3 py-1 rounded-lg shadow flex items-center gap-1">
