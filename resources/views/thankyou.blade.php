                ...
                <div class="p-12 text-center">
                    ...
                    <div class="mb-8 relative inline-block">
                        ...
                        <div class="relative bg-gradient-to-r from-green-400 to-emerald-500 rounded-full p-6">
                            <center>
                                                            <svg class="w-24 h-24 from-blue-900 to-blue-950" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <!-- Main Heading -->
                    <h1 class="text-5xl font-bold bg-gradient-to-r from-blue-900 to-blue-950 bg-clip-text text-transparent mb-4">
                        Terima Kasih!
                    </h1>
                    ...
                    <div class="mt-8">
                        <form method="POST" action="{{ route('logout') }}">
                            @csrf
                            <button type="submit" 
                                class="bg-gradient-to-r from-red-500 to-red-600 hover:from-red-600 hover:to-red-700  px-10 py-4 rounded-xl font-bold transform hover:scale-105 transition-all duration-200 flex items-center justify-center gap-3 mx-auto text-lg text-white">
